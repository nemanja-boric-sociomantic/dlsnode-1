   ...
   ***************************************************************************/
    ...
    ***************************************************************************/
    ...
    /***************************************************************************
        ...
        TODO: this is a class, since there's no outer.
    ...
    public class Nonblocking
    {
        /**************************************************************************
            ...
            Params:
                ...
                fd = file descriptor to read from
                offset = offset in the file to read from
                finish_callback_dg = delegate to call when the request has finished,
                    passing the return value of the pread call
                suspendable_request_handler = interface for waking up the
